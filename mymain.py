...
def preprocess(train, test,next_fold, t):
    ...
    if t == 1:
        ...
        print(f'start_last_year:{start_last_year}')
        print(f'end_last_year:{end_last_year}')
        print(f'train:{train}')
        print(f'tmp_train_time_ids:{tmp_train_time_ids}')
...
if __name__ == '__main__':
    ...
    # print('test1:',test1['Date'].head(5))
    # print('test:',test['Date'].head(5))
    ...
    #     train = preprocess(train, next_fold, t)
    
    train = preprocess(train, test1, next_fold, t)
